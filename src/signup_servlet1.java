...
/**
 * Servlet implementation class signup_servlet1
 */
@WebServlet("/signup_servlet1")
public class signup_servlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(User u:list){
			out.print("<tr><td>"+u.getUname()+"</td><td>"+u.getEmail()+"</td><td>"+u.getPass()+"</td><td>"+u.getRepass()+"</td><td>"+u.getMobno()+"</td><td>"+u.getSeqques()+"</td><td>"+u.getAnswer()+"</td><td><a href='EditServlet?email="+u.getEmail()+"' style='color:blue;font-size:larger;background-color:lightblue'><input type='submit' value='Update'></a></td></tr>");
		}
		out.print("</table>");
		out.print("<br><br>");
