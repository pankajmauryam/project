      ...
      //  DateFormat dateFormat = new SimpleDateFormat("MM-dd-yyyy HH:mm:ss");
       // Date date = new Date();
        ...
        if (errorMsg != null) 
        {
            ...
            msg = "<font color=green>" + errorMsg + "</font>";
               ...
               rs = ps.executeQuery();
                if (rs != null) 
                {
                    ...
                    else 
                    {
                       ...
                       // request.setAttribute("date", dateFormat.format(date));
                        out.print(msg);
                        request.setAttribute("msg", "<font color=green>User Name or Password is wrong.</font>");
                        request.setAttribute("passwordVal", "<font color=green>User Name or Password is wrong.</font>");
                        RequestDispatcher rd = getServletContext().getRequestDispatcher("/login.jsp");
                        rd.include(request, response);
                    }
                } 
