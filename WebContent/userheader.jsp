...
<nav class="navbar navbar-inverse">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="index1.jsp">Home</a></li>
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="Admin.jsp">Registration</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li style=" padding-top:10px;color:green"><p ><%= session.getAttribute("loginId") %><span class="glyphicon glyphicon-user" ></span><a href="LogoutServlet" style="text-color:black"><input type="submit" value="Logout!!" ></a></p></li>
