...
<div class="container-fluid bg-3 text-center">    
  ...
  <div class="row">
    <div class="col-sm-3">
      <p>Some text..</p>
      <img src="img/iphone.jpg" class="img-responsive" style="width:100%" alt="Image">
    ...
    <div class="col-sm-3"> 
      <p>Some text..</p>
      <img src="img/iphone7.jpg" class="img-responsive" style="width:100%" alt="Image">
       <p>Review this product</p>
		<a href="#">
          <span class="glyphicon glyphicon-star-empty"></span>
        </a>
    ...
    <div class="col-sm-3"> 
      <p>Some text..</p>
      <img src="img/three.jpg" class="img-responsive" style="width:100%" alt="Image">
       <p>Review this product</p>
		<a href="#">
          <span class="glyphicon glyphicon-star-empty"></span>
        </a>
    ...
    <div class="col-sm-3">
      <p>Some text..</p>
      <img src="img/ebay.jpg" class="img-responsive" style="width:100%" alt="Image">
       <p>Review this product</p>
		<a href="#">
          <span class="glyphicon glyphicon-star-empty"></span>
        </a>
...
<div class="container-fluid bg-3 text-center">    
  <div class="row">
    ...
    <div class="col-sm-3">
      <p>Some text..</p>
      <img src="img/porche.jpg" class="img-responsive" style="width:100%" alt="Image">
   ...
   <div class="row">     
      ...
      <h3>News &amp; Events <i class="fa fa-play"></i></h3>    
            <div class="vticker">         
               ...
               <div class="dbox">                
               <h5>   Send Mail&nbsp;&nbsp; </h5>                
               <small><a href="2dec-news.html" >Two week ISTE Main Workshop on Control...</a></small> </div>           
         <div class="dbox">               
          <h5>    Services&nbsp;&nbsp; </h5>               
           <small><a href="15dec-news.html" > International Symposium on Signal...</a></small> </div>              
           <div class="dbox">                
           <h5>     Process of Educational Verification &nbsp;&nbsp;</h5> 
           <small><a href="6jan.html" > International Symposium on Emerging...</a></small> </div>              
<div class="dbox">               
 <h5>      Products&nbsp;&nbsp; </h5>                
 <small><a href="16mar.html" >2015 International Conference...</a></small> 
 </div></ul> </div>       
   <a href="news-and-events.html" class="btn btn-primary btn-md margin-top10">MORE <i class="fa fa-angle-right"></i></a> </div>   
     <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">         
      <h3>Manager <i class="fa fa-play"></i></h3>          
      <p><img src="img/shiva.jpg"  width=20%  class="imgResponsive"></p>          
      <p> Providing technical education   </p>          
      <a href="#" class="btn btn-primary btn-md">MORE <i class="fa fa-angle-right"></i></a> </div>        
     <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">         
      <h3>CEO <i class="fa fa-play"></i></h3>         
       <p><img src="img/shivam.jpg" class="imgResponsive0" width=20% height=125 ></p>          
       <p>Globalization  and liberalization...</p>         
        <a href="#" class="btn btn-primary btn-md">MORE <i class="fa fa-angle-right"></i></a> </div>      
       <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">         
        <h3>Important Links <i class="fa fa-play"></i></h3>          
       <a href="send.jsp" class="btn btn-success btn-block" role="button"><i class="fa fa-check"></i>  &nbsp;  Send Mail</a> 
       <a href="services.jsp" class="btn btn-success btn-block" role="button"><i class="fa fa-check"></i> &nbsp; Services</a> 
       
<a href="mba-admission-procedure.html" class="btn btn-success btn-block" role="button"><i class="fa fa-check"></i>&nbsp; Product Specification</a>
<a href="#" class="btn btn-success btn-block" role="button">MORE <i class="fa fa-angle-right"></i></a> </div></div>  
</div></div>

<!-- Footer -->
<br><br>
<div id="footer" style="background-color:darkred">
...
<ul class="nav navbar-nav">
 <li><a href="send.jsp">Feedback</a></li>
