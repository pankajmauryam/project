...
<br><br><br>
		...
		<table border=1 align=center class="table">
			...
			<tr>
			  <th colspan=2>
			  <input type="text" name="user" value="User" readonly width=100></th>
			</tr>
			<tr>
			...
			<tr>
			  <th colspan=2>
			  <input type="text" name="id" placeholder="Enter Your ID" width=100></th>
			</tr>
			<tr>
			...
			<tr>
			 ...
			 <tr>
				<th colspan=2>
				<input type="text" name="mobno"  placeholder="Please Enter Your Mobile No. Here"></th>
			</tr>
