...
<nav class="navbar navbar-inverse">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="index1.jsp">Home</a></li>
         <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Admin Control<span class="caret"></span></a>
        <ul class="dropdown-menu">
    
         
          <li><a href="signup_servlet">View Details</a></li>
          <li><a href="signup_servlet1">Update Details</a></li>
		   <li><a href="signup_servlet2">Delete Details</a></li>
        </ul>
      </li>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li  style="color:green;padding-top:10px;size=5;"><p><%= session.getAttribute("loginId") %><a href="LogoutServlet"><span class="glyphicon glyphicon-user" ></span><input type="submit" value="Logout!!"></a></p></li>
